...
public class StudentTest 
{
    ...
    public void AddStudent()
    {
        ...
        Student student = new(1, "Pepito Pérez", new List<double>() { 3, 4.5 });
        stundentRepositoryMock.Setup(p => p.Add(student)).Returns(student);

        var studentController = new StudentController(stundentRepositoryMock.Object, LogbookMock.Object);

        Assert.Equal(student, studentController.Add(student));
    }
}